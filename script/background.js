    ...
    chrome.webRequest.onBeforeSendHeaders.addListener(
      function(info) {
        ...
        alert('Domain: ' + domain+ ' Third Party: '+ url_thirdparty + " "+ 
url_thirdparty.indexOf(domain));
...
// null
    function checkIfVisited(url){
        var urlModified = url.replace(".", "_dot_")
        alert(url);
        ...
        if(user.website.hasOwnProperty(url))
            alert(user.website[url]);
